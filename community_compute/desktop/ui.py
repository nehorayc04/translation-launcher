...
# brand shown in the nav rail (app.py may override before building the rail)
BRAND_SHORT = "צי"
BRAND_WIDE = "צי התרגום"
...
class NavRail(QWidget):
    ...
    def _apply_width(self, expand: bool, animate=True):
        ...
        self.brand.setText(BRAND_WIDE if expand else BRAND_SHORT)
