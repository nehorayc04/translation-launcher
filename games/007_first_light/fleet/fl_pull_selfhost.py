"""Pull finished 007 First Light pool lines from the SELF-HOSTED cc_server straight into
fleet/hebrew.json. Mirrors crimson_desert/fleet/cc_pull_selfhost.py exactly, filtered to
game='007-first-light' only — never touches a crimson-desert row.

Usage: python fl_pull_selfhost.py [--apply]
"""
import json
import os
import subprocess
