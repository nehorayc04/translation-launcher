#!/usr/bin/env python3
r"""
aco_deploy.py — write a rebuilt resource back into an AC Odyssey v28 forge by
...
works even if the backup is lost/deleted.
    ...
    python aco_deploy.py <forge> apply   <resource_id> <blob.bin>
    python aco_deploy.py <forge> inplace <resource_id> <blob.bin>   # only if it fits
    python aco_deploy.py <forge> verify  <resource_id>
    python aco_deploy.py <forge> revert
"""
import argparse
import json
import os
...
from aco_forge import Forge  # noqa: E402
