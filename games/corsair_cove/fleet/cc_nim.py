"""Corsair Cove translator worker — New-Era, six-language panel.
...
Run: python cc_nim.py <groq|sambanova|nim>   (keys in keys.json next to this file)
"""
...
S1 = ("You are a senior Hebrew localizer for Corsair Cove — a Caribbean pirate haven in the age "
...
def main():
    ...
    print(f"Corsair Cove New-Era worker | slice {len(corpus)} lines | already done {len(out)} | "
