"""I/O helper — emit the next 500 UNtranslated UI strings. Does NOT translate.
...
# skip.json = ids that are UNtranslatable by design (usernames/handles/graffiti/
# code snippets/error-codes/foreign-language names) — they stay English in-game.
# Treated as "done" so the loop can reach "All done!".
