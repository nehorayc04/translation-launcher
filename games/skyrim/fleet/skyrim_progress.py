...
HIST = os.path.join(HERE, "skyrim_progress_hist.json")
BANKS = os.path.join(HERE, "banks")

GAME_ID = "skyrim"                  # MUST match the Supabase games row id (the dashboard joins on it)
...
def main():
    ...
    print(f"Skyrim pusher: total {total} sentences ({len(SENT)} lines; "
