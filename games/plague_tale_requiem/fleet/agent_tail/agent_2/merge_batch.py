#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate + merge THIS agent's batch into its own fleet bank (../../banks/out_agent2.json).
...
MYBANK = os.path.join(BANKS, "out_agent2.json")
...
def main():
    ...
    print("%s now %d  (~%d of this slot left). The fleet pull (~3 min) folds it into hebrew.json." % ("out_agent2.json", len(mine), remaining))
