"""
Far Cry 5 Dunia FAT2 v10 archive reader (pure Python, no deps for reading raw
...
Format (cracked 2026-07-24, validated against the real common.fat):
  header:
    ...
    @4  u32 version = 11               (FC5; FCBConverter only handles <=9)
  ...
  For FAT v11 (FC5) the LZ4 path is ONE standard LZ4 block over the whole entry
...
class Fat:
    ...
    def read_data(self, en):
        ...
        if en.scheme == 1:
            from fc5_lzo import lzo_decompress
