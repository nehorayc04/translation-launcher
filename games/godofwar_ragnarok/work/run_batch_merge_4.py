...
PART1_F = os.path.join(HERE, "trans_4_part_1.json")
PART2_F = os.path.join(HERE, "trans_4_part_2.json")
PART3_F = os.path.join(HERE, "trans_4_part_3.json")
PART4_F = os.path.join(HERE, "trans_4_part_4.json")
