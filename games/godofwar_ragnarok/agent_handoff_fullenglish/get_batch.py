"""Emit the next N untranslated FULL-ENGLISH GoWR strings for the agent to translate.
Writes current_batch.json = {id: {en, he:""}}. Loop until "All done!"."""
import json, os, sys
...
batch = {k: {"en": src[k]["en"], "he": ""} for k in todo[:N]}
