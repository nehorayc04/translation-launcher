# -*- coding: utf-8 -*-
"""Serve the next N gender-fix lines that aren't done yet -> current_batch.json.
Each = {id: {"en":..., "he":<current, wrong gender>, "ar":<ground truth>, "target":"f"/"m"}}.
The agent rewrites each id's value to the SAME Hebrew line but with the addressee gender
fixed to match the Arabic. Run:  python get_batch.py 60
"""
import json, os, sys
