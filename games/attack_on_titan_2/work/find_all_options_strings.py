...
WANT = ["Control Assistance", "Slow Motion During Battle", "Extra-wall Map Speed",
        "Skip Journey Events", "Preferred Input Method", "Default Network Settings",
        "Game 1", "Game 2", "Controls", "Camera", "Audio", "Graphics 1", "Graphics 2",
        "Keyboard and Mouse", "Easy", "OFF", "ON", "Normal", "Offline"]
for w in WANT:
    idxs = [i for i, s in enumerate(strs) if s is not None and s.strip() == w]
    print(f"{w!r}: {idxs}")
